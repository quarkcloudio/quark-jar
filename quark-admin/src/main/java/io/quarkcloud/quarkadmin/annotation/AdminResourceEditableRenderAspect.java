...
@Aspect
@Component
public class AdminResourceEditableRenderAspect {
     ...
     * 环绕通知
     */
    @Around("AdminResourceEditableRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceEditableRender annotation = method.getAnnotation(AdminResourceEditableRender.class);
        if (annotation==null) {

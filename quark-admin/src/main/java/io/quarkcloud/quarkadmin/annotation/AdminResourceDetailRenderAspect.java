...
@Aspect
@Component
public class AdminResourceDetailRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceDetailRender)")
    private void AdminResourceDetailRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceDetailRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceDetailRender annotation = method.getAnnotation(AdminResourceDetailRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("detailRender", newContext);
    }
}

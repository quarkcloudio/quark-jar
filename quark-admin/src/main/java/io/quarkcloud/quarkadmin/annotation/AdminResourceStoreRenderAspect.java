...
@Aspect
@Component
public class AdminResourceStoreRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceStoreRender)")
    private void AdminResourceStoreRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceStoreRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceStoreRender annotation = method.getAnnotation(AdminResourceStoreRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("storeRender", newContext);
    }
}

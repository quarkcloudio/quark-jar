...
@Aspect
@Component
public class AdminResourceImportTemplateRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceImportTemplateRender)")
    private void AdminResourceImportTemplateRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceImportTemplateRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceImportRender annotation = method.getAnnotation(AdminResourceImportRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("importTemplateRender", newContext);
    }
}

...
@Aspect
@Component
public class AdminResourceFormRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceFormRender)")
    private void AdminResourceFormRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceFormRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceFormRender annotation = method.getAnnotation(AdminResourceFormRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("formRender", newContext);
    }
}

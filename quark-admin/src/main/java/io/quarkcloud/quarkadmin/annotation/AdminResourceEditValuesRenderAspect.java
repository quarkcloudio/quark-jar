...
@Aspect
@Component
public class AdminResourceEditValuesRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceEditValuesRender)")
    private void AdminResourceEditValuesRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceEditValuesRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceEditValuesRender annotation = method.getAnnotation(AdminResourceEditValuesRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("editValuesRender", newContext);
    }
}

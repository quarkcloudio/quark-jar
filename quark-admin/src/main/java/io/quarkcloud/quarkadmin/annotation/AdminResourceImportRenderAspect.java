...
@Aspect
@Component
public class AdminResourceImportRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceImportRender)")
    private void AdminResourceImportRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceImportRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("importRender", newContext);
    }
}

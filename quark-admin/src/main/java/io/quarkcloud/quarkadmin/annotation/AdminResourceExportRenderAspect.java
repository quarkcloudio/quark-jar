...
@Aspect
@Component
public class AdminResourceExportRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceExportRender)")
    private void AdminResourceExportRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceExportRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceExportRender annotation = method.getAnnotation(AdminResourceExportRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("exportRender", newContext);
    }
}

...
@Aspect
@Component
public class AdminLayoutRenderAspect {

    // 加载基础资源包路径
    public String[] basePackages = Config.getInstance().getBasePackages("admin");

    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminLayoutRender)")
    private void AdminLayoutRender() {}

    /**
     * 环绕通知
     */
    @Around("AdminLayoutRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminLayoutRender annotation = method.getAnnotation(AdminLayoutRender.class);
        if (annotation==null) {
        ...
        // 获取所有类
        Set<Class<? extends LayoutImpl>> classes = reflections.getSubTypesOf(LayoutImpl.class);

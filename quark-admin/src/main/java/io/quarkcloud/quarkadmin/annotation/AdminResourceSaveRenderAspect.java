...
@Aspect
@Component
public class AdminResourceSaveRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceSaveRender)")
    private void AdminResourceSaveRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceSaveRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceSaveRender annotation = method.getAnnotation(AdminResourceSaveRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("saveRender", newContext);
    }
}

...
@Aspect
@Component
public class AdminResourceActionValuesRenderAspect {
    ...
    @Pointcut("@annotation(io.quarkcloud.quarkadmin.annotation.AdminResourceActionValuesRender)")
    private void AdminResourceActionValuesRender() {}
     ...
     * 环绕通知
     */
    @Around("AdminResourceActionValuesRender()")
    public Object advice(ProceedingJoinPoint joinPoint) throws Throwable {
        ...
        // 得到方法上的注解
        AdminResourceActionValuesRender annotation = method.getAnnotation(AdminResourceActionValuesRender.class);
        if (annotation==null) {
        ...
        // 调用类方法
        return classLoader.setClassPath(loadPackages[0]+resource).doMethod("actionValuesRender", newContext);
    }
}

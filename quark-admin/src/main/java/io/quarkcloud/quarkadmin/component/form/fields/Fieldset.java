...
public class Fieldset extends Component {
    ...
    // 支持两种方式，type="group" 会用input.group 包裹;如果不配置 默认使用 space
    @JsonInclude(JsonInclude.Include.NON_DEFAULT)
    String type;
    ...
    public Fieldset setWidth(Object width) {
    ...
    // ));
    public Fieldset setRules(List<Rule> rules) {
    ...
    // ));
    public Fieldset setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Fieldset setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Fieldset buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Fieldset setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Fieldset setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Fieldset().setWhen(option, callback)
    public Fieldset setWhen(Object option, Closure callback) {
    ...
    //
    // new Fieldset().setWhen(">", option, callback)
    public Fieldset setWhen(String operator, Object option, Closure callback) {
    ...
    public Fieldset hideFromIndex(boolean callback) {
    ...
    public Fieldset hideFromDetail(boolean callback) {
    ...
    public Fieldset hideWhenCreating(boolean callback) {
    ...
    public Fieldset hideWhenUpdating(boolean callback) {
    ...
    public Fieldset hideWhenExporting(boolean callback) {
    ...
    public Fieldset hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Fieldset onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Fieldset onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Fieldset showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Fieldset showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Fieldset showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Fieldset showOnImporting(boolean callback) {
        this.showOnImport = callback;
    ...
    public Fieldset onlyOnCreating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = true;
        this.showOnUpdate = false;
    ...
    public Fieldset onlyOnUpdating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = false;
        this.showOnUpdate = true;

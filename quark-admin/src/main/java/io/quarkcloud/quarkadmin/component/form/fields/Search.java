...
public class Search extends Component {
    ...
    public Search setOptions(List<Option> options) {
        this.options = options;
        return this;
    }

    public Search setOptions(List<?> list, String labelName, String valueName) {
    ...
    // ));
    public Search setRules(List<Rule> rules) {
    ...
    // ));
    public Search setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Search setUpdateRules(List<Rule> rules) {

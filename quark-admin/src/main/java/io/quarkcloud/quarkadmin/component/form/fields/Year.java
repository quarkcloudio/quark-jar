...
public class Year extends Component {
    ...
    public Year setWidth(Object width) {
    ...
    // ));
    public Year setRules(List<Rule> rules) {
    ...
    // ));
    public Year setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Year setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Year buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Year setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Year setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Year().setWhen(option, callback)
    public Year setWhen(Object option, Closure callback) {
    ...
    //
    // new Year().setWhen(">", option, callback)
    public Year setWhen(String operator, Object option, Closure callback) {
    ...
    public Year hideFromIndex(boolean callback) {
    ...
    public Year hideFromDetail(boolean callback) {
    ...
    public Year hideWhenCreating(boolean callback) {
    ...
    public Year hideWhenUpdating(boolean callback) {
    ...
    public Year hideWhenExporting(boolean callback) {
    ...
    public Year hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Year onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Year onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Year showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Year showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Year showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Year showOnImporting(boolean callback) {
        this.showOnImport = callback;

...
public class Editor extends Component {
    ...
    public Editor setWidth(Object width) {
    ...
    // ));
    public Editor setRules(List<Rule> rules) {
    ...
    // ));
    public Editor setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Editor setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Editor buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Editor setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Editor setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Editor().setWhen(option, callback)
    public Editor setWhen(Object option, Closure callback) {
    ...
    //
    // new Editor().setWhen(">", option, callback)
    public Editor setWhen(String operator, Object option, Closure callback) {
    ...
    public Editor hideFromIndex(boolean callback) {
    ...
    public Editor hideFromDetail(boolean callback) {
    ...
    public Editor hideWhenCreating(boolean callback) {
    ...
    public Editor hideWhenUpdating(boolean callback) {
    ...
    public Editor hideWhenExporting(boolean callback) {
    ...
    public Editor hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Editor onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Editor onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Editor showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Editor showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Editor showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Editor showOnImporting(boolean callback) {
        this.showOnImport = callback;

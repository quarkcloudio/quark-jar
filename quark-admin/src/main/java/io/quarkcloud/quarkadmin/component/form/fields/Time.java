...
public class Time extends Component {
    ...
    public Time setWidth(Object width) {
    ...
    // ));
    public Time setRules(List<Rule> rules) {
    ...
    // ));
    public Time setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Time setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Time buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Time setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Time setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Time().setWhen(option, callback)
    public Time setWhen(Object option, Closure callback) {
    ...
    //
    // new Time().setWhen(">", option, callback)
    public Time setWhen(String operator, Object option, Closure callback) {
    ...
    public Time hideFromIndex(boolean callback) {
    ...
    public Time hideFromDetail(boolean callback) {
    ...
    public Time hideWhenCreating(boolean callback) {
    ...
    public Time hideWhenUpdating(boolean callback) {
    ...
    public Time hideWhenExporting(boolean callback) {
    ...
    public Time hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Time onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Time onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Time showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Time showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Time showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Time showOnImporting(boolean callback) {
        this.showOnImport = callback;

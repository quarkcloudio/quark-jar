...
public class Hidden extends Component {
    ...
    // ));
    public Hidden setRules(List<Rule> rules) {
    ...
    // ));
    public Hidden setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Hidden setUpdateRules(List<Rule> rules) {

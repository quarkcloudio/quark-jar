...
public class Month extends Component {
    ...
    public Month setWidth(Object width) {
    ...
    // ));
    public Month setRules(List<Rule> rules) {
    ...
    // ));
    public Month setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Month setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Month buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Month setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Month setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Month().setWhen(option, callback)
    public Month setWhen(Object option, Closure callback) {
    ...
    //
    // new Month().setWhen(">", option, callback)
    public Month setWhen(String operator, Object option, Closure callback) {
    ...
    public Month hideFromIndex(boolean callback) {
    ...
    public Month hideFromDetail(boolean callback) {
    ...
    public Month hideWhenCreating(boolean callback) {
    ...
    public Month hideWhenUpdating(boolean callback) {
    ...
    public Month hideWhenExporting(boolean callback) {
    ...
    public Month hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Month onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Month onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Month showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Month showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Month showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Month showOnImporting(boolean callback) {
        this.showOnImport = callback;

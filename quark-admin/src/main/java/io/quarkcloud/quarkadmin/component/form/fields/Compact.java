...
public class Compact extends Component {
    ...
    public Compact setWidth(Object width) {
    ...
    // ));
    public Compact setRules(List<Rule> rules) {
    ...
    // ));
    public Compact setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Compact setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Compact buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Compact setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Compact setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Compact().setWhen(option, callback)
    public Compact setWhen(Object option, Closure callback) {
    ...
    //
    // new Compact().setWhen(">", option, callback)
    public Compact setWhen(String operator, Object option, Closure callback) {
    ...
    public Compact hideFromIndex(boolean callback) {
    ...
    public Compact hideFromDetail(boolean callback) {
    ...
    public Compact hideWhenCreating(boolean callback) {
    ...
    public Compact hideWhenUpdating(boolean callback) {
    ...
    public Compact hideWhenExporting(boolean callback) {
    ...
    public Compact hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Compact onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Compact onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Compact showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Compact showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Compact showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Compact showOnImporting(boolean callback) {
        this.showOnImport = callback;

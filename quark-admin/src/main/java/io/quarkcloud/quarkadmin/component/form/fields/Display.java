...
public class Display extends Component {
    ...
    public Display setWidth(Object width) {
    ...
    // ));
    public Display setRules(List<Rule> rules) {
    ...
    // ));
    public Display setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Display setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Display buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Display setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Display setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Display().setWhen(option, callback)
    public Display setWhen(Object option, Closure callback) {
    ...
    //
    // new Display().setWhen(">", option, callback)
    public Display setWhen(String operator, Object option, Closure callback) {
    ...
    public Display hideFromIndex(boolean callback) {
    ...
    public Display hideFromDetail(boolean callback) {
    ...
    public Display hideWhenCreating(boolean callback) {
    ...
    public Display hideWhenUpdating(boolean callback) {
    ...
    public Display hideWhenExporting(boolean callback) {
    ...
    public Display hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Display onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Display onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Display showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Display showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Display showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Display showOnImporting(boolean callback) {
        this.showOnImport = callback;

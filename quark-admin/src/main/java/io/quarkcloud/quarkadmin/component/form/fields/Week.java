...
public class Week extends Component {
    ...
    public Week setWidth(Object width) {
    ...
    // ));
    public Week setRules(List<Rule> rules) {
    ...
    // ));
    public Week setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Week setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Week buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Week setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Week setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Week().setWhen(option, callback)
    public Week setWhen(Object option, Closure callback) {
    ...
    //
    // new Week().setWhen(">", option, callback)
    public Week setWhen(String operator, Object option, Closure callback) {
    ...
    public Week hideFromIndex(boolean callback) {
    ...
    public Week hideFromDetail(boolean callback) {
    ...
    public Week hideWhenCreating(boolean callback) {
    ...
    public Week hideWhenUpdating(boolean callback) {
    ...
    public Week hideWhenExporting(boolean callback) {
    ...
    public Week hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Week onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Week onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Week showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Week showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Week showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Week showOnImporting(boolean callback) {
        this.showOnImport = callback;

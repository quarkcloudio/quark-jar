...
public class Text extends Component {
    ...
    // ));
    public Text setRules(List<Rule> rules) {
    ...
    // ));
    public Text setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Text setUpdateRules(List<Rule> rules) {

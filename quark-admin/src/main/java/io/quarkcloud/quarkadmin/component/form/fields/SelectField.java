...
public class SelectField extends Component {
    ...
    public SelectField setOptions(List<Option> options) {
        this.options = options;
        return this;
    }

    public SelectField setOptions(List<?> list, String labelName, String valueName) {
    ...
    public SelectField onlyOnCreating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = true;
        this.showOnUpdate = false;
    ...
    public SelectField onlyOnUpdating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = false;
        this.showOnUpdate = true;

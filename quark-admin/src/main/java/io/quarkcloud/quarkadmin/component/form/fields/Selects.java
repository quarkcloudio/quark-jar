...
public class Selects extends Component {
    ...
    // ));
    public Selects setRules(List<Rule> rules) {
    ...
    // ));
    public Selects setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Selects setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Selects buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Selects setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Selects setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Selects().setWhen(option, callback)
    public Selects setWhen(Object option, Closure callback) {
    ...
    //
    // new Selects().setWhen(">", option, callback)
    public Selects setWhen(String operator, Object option, Closure callback) {
    ...
    public Selects hideFromIndex(boolean callback) {
    ...
    public Selects hideFromDetail(boolean callback) {
    ...
    public Selects hideWhenCreating(boolean callback) {
    ...
    public Selects hideWhenUpdating(boolean callback) {
    ...
    public Selects hideWhenExporting(boolean callback) {
    ...
    public Selects hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Selects onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Selects onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Selects showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Selects showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Selects showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Selects showOnImporting(boolean callback) {
        this.showOnImport = callback;

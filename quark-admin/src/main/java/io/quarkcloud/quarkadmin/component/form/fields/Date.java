...
public class Date extends Component {
    ...
    public Date setWidth(Object width) {
    ...
    // ));
    public Date setRules(List<Rule> rules) {
    ...
    // ));
    public Date setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Date setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Date buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Date setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Date setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Date().setWhen(option, callback)
    public Date setWhen(Object option, Closure callback) {
    ...
    //
    // new Date().setWhen(">", option, callback)
    public Date setWhen(String operator, Object option, Closure callback) {
    ...
    public Date hideFromIndex(boolean callback) {
    ...
    public Date hideFromDetail(boolean callback) {
    ...
    public Date hideWhenCreating(boolean callback) {
    ...
    public Date hideWhenUpdating(boolean callback) {
    ...
    public Date hideWhenExporting(boolean callback) {
    ...
    public Date hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Date onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Date onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Date showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Date showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Date showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Date showOnImporting(boolean callback) {
        this.showOnImport = callback;

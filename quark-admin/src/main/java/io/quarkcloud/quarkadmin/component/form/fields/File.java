...
public class File extends Component {
    ...
    public File setWidth(Object width) {
    ...
    // ));
    public File setRules(List<Rule> rules) {
    ...
    // ));
    public File setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public File setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public File buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public File setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public File setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new File().setWhen(option, callback)
    public File setWhen(Object option, Closure callback) {
    ...
    //
    // new File().setWhen(">", option, callback)
    public File setWhen(String operator, Object option, Closure callback) {
    ...
    public File hideFromIndex(boolean callback) {
    ...
    public File hideFromDetail(boolean callback) {
    ...
    public File hideWhenCreating(boolean callback) {
    ...
    public File hideWhenUpdating(boolean callback) {
    ...
    public File hideWhenExporting(boolean callback) {
    ...
    public File hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public File onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public File onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public File showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public File showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public File showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public File showOnImporting(boolean callback) {
        this.showOnImport = callback;

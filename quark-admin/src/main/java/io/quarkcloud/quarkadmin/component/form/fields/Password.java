...
public class Password extends Component {
    ...
    // ));
    public Password setRules(List<Rule> rules) {
    ...
    // ));
    public Password setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Password setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Password buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Password setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Password setFilters(Map<String, String> filters) {
    ...
    // 设置When组件数据
    //
    // new Password().setWhen(option, callback)
    public Password setWhen(Object option, Closure callback) {
    ...
    //
    // new Password().setWhen(">", option, callback)
    public Password setWhen(String operator, Object option, Closure callback) {
    ...
    public Password onlyOnCreating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = true;
        this.showOnUpdate = false;
    ...
    public Password onlyOnUpdating() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = false;
        this.showOnUpdate = true;

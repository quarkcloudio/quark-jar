...
public class Dependency extends Commponent {
    ...
    public Dependency setWidth(Object width) {
    ...
    // ));
    public Dependency setRules(List<Rule> rules) {
    ...
    // ));
    public Dependency setCreationRules(List<Rule> rules) {
    ...
    // rule.unique("admins", "username", "用户名已存在"),
    // ));
    public Dependency setUpdateRules(List<Rule> rules) {
    ...
    // 生成前端验证规则
    public Dependency buildFrontendRules(String path) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Dependency setFilters(boolean filters) {
    ...
    // 表头的筛选菜单项，当值为 true 时，自动使用 valueEnum 生成，只在列表页中有效
    public Dependency setFilters(Map<String, String> filters) {
    ...
    public Dependency hideFromIndex(boolean callback) {
    ...
    public Dependency hideFromDetail(boolean callback) {
    ...
    public Dependency hideWhenCreating(boolean callback) {
    ...
    public Dependency hideWhenUpdating(boolean callback) {
    ...
    public Dependency hideWhenExporting(boolean callback) {
    ...
    public Dependency hideWhenImporting(boolean callback) {
    ...
    // Specify that the element should be hidden from the index view.
    public Dependency onIndexShowing(boolean callback) {
        this.showOnIndex = callback;
    ...
    // Specify that the element should be hidden from the detail view.
    public Dependency onDetailShowing(boolean callback) {
        this.showOnDetail = callback;
    ...
    // Specify that the element should be hidden from the creation view.
    public Dependency showOnCreating(boolean callback) {
        this.showOnCreation = callback;
    ...
    // Specify that the element should be hidden from the update view.
    public Dependency showOnUpdating(boolean callback) {
        this.showOnUpdate = callback;
    ...
    // Specify that the element should be hidden from the export file.
    public Dependency showOnExporting(boolean callback) {
        this.showOnExport = callback;
    ...
    // Specify that the element should be hidden from the import file.
    public Dependency showOnImporting(boolean callback) {
        this.showOnImport = callback;
    ...
    public Dependency onlyOnDetail() {
    ...
    public Dependency onlyOnImport() {
        this.showOnIndex = false;
        this.showOnDetail = false;
        this.showOnCreation = false;
        this.showOnUpdate = false;
    ...
    public Dependency exceptOnForms() {
        this.showOnIndex = true;
        this.showOnDetail = true;
        this.showOnCreation = false;
        this.showOnUpdate = false;

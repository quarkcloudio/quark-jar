...
-- ----------------------------
INSERT INTO `departments` VALUES (1, 0, '夸克云科技', 0, 1, '2024-10-10 19:20:41.601', '2024-10-10 19:20:41.601');
INSERT INTO `departments` VALUES (2, 1, '研发中心', 0, 1, '2024-10-10 19:20:41.601', '2024-10-10 19:20:41.601');
...
CREATE TABLE `permissions`  (
  `id` bigint(20) NOT NULL AUTO_INCREMENT,
  `name` varchar(500) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NOT NULL,
  `guard_name` varchar(100) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `positions` VALUES (1, '董事长', 0, 1, '', '2024-10-10 19:20:41.604', '2024-10-10 19:20:41.604');
INSERT INTO `positions` VALUES (2, '项目经理', 0, 1, '', '2024-10-10 19:20:41.604', '2024-10-10 19:20:41.604');
...
CREATE TABLE `users`  (
  ...
  `department_id` smallint(6) UNSIGNED NULL DEFAULT NULL,
  `position_ids` varchar(1000) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin NULL DEFAULT NULL,

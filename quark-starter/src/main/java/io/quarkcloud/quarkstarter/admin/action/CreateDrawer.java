...
public class CreateDrawer<M extends ResourceMapper<T>, T> extends DrawerImpl<ResourceMapper<T>, T> {
    ...
    // 初始化
    public CreateDrawer(Context context, ResourceImpl<M, T> resource) {
